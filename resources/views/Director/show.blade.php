...
@section('title', $director['first_name'])
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="gallery"
                        ...
                        <a href=""><img src="{{ asset('images/directors/' . $director['image']) }}"
                ...
                <div class="col-md-6">
                    <div class="info">
                        <h4 style="font-family: Acme, sans-serif;font-size: 32px; margin-bottom: 30px">
                            {{ $director['first_name'] }} {{ $director['last_name'] }}</h4>
                        <div>
                            <h4
                        ...
                        <div>
                            <h4
                                style="margin-top: 22px;font-family: 'Balsamiq Sans', cursive;font-size: 28px;color: #8749ed; margin-left: 15px">
                                Nomber of movies Directed</h4>
                        </div>
                        <div class="summary">
                            <p
                                style="margin-left: 22px;color: rgba(255,255,255,0.97);font-size: 16px;margin-bottom: 16px;font-family: Nunito, sans-serif;">
                                {{count($director->movies)}} movies
                            </p>
                        </div>
                        <div>
                            <h4
                                style="margin-top: 22px;font-family: 'Balsamiq Sans', cursive;font-size: 28px;color: #8749ed; margin-left: 15px">
                                Nomber of series Directed</h4>
                        </div>
                        <div class="summary">
                            <p
                                style="margin-left: 22px;color: rgba(255,255,255,0.97);font-size: 16px;margin-bottom: 16px;font-family: Nunito, sans-serif;">
                                {{count($director->series)}} series
                            </p>
                        </div>
                ...
                <div class="col">
                    <div style="margin-top: 22px;">
                        ...
                        <div class="row no-gutters row-cols-3 justify-content-center align-items-center"
                            ...
                            @foreach ($director->series as $serie)
                                <div class="col">
                                    <div class="justify-content-center spacer-slider">
