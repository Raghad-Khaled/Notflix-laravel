            ...
            <div>
                <div id="first_Col">
                    <h1 style="color: rgb(101,149,254);text-align: left;margin-top: 25px;font-size: 46px;">
                        Welcome to NOTflix&nbsp;</h1>
                    <p style="font-size: 15px;letter-spacing: 2px;font-style: italic;margin-left: 12px;">Find
                        the latest and greatest Movies, Series,&nbsp; Novels that fit your taste&nbsp;</p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="margin-top: 22px; text-align: center;">
                        <a class="d-inline" style="color: rgb(255,255,255);" href="{{ route('register') }}">Already
                            Have An account?&nbsp;</a>

                        @if (Route::has('password.request'))
                            <a class="d-inline ml-5" style="color: rgb(255,255,255);"
